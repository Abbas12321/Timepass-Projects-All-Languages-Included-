...
const App = () =>{
    ...
    <h1 className="container text-center text-danger ">Material Ui</h1>
  ...
  <div class="card-body">
    ...
    <a href="head" class="btn btn-primary">Go somewhere</a>
  </div>
</div></div>
    <div className="col-sm"><div class="card">
  ...
  <div class="card-body">
    <h5 class="card-title">Card title</h5>
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
    <a href="class" class="btn btn-primary">Go somewhere</a>
  </div>
</div></div>
    <div className="col-sm"><div class="card">
